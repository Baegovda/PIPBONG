...
**Current version:** `0.5.41` (from `project(SuckbongMachine VERSION 0.5.41)` in `CMakeLists.txt` → `SBM_VERSION` compile definition)
...
*Last consolidated: 2026-06-24. Current application version: 0.5.41.*
